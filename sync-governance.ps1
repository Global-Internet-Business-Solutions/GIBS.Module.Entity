...
.EXAMPLE
  ...
  read oqtane playbook GOVERNANCE and follow the rules. Never modify files in oqtane.framework folder or sub-folders
#>
...
$PlaybookRoot = "C:\Websites\oqtane-ai-playbook\module-playbook-example"
